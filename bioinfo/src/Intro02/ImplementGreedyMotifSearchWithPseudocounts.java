...
public class ImplementGreedyMotifSearchWithPseudocounts {
    ...
    public static void main(String[] args) {
        try {
            ImplementGreedyMotifSearchWithPseudocounts();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void ImplementGreedyMotifSearchWithPseudocounts() throws FileNotFoundException {
